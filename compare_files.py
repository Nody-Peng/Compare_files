...
root.geometry("900x250")  # 調整視窗高度以顯示額外資訊
...
tk.Label(footer, text="Author: Nody Peng", font=footer_font, bg="#f0f0f0").pack()
tk.Label(footer, text="Date: 2024.08.16", font=footer_font, bg="#f0f0f0").pack()
